...
class DuplicatePairReviewTool(tk.Toplevel):
    ...
    def _load_track(
        self, panel: ttk.Frame, path: str, *, winner_mark: str = ""
    ) -> dict[str, object]:
    ...
    def _load_pair(self) -> None:
        ...
        self._left_tags = self._load_track(
            self.left_panel, pair.left_path, winner_mark=left_mark
        )
        self._right_tags = self._load_track(
            self.right_panel, pair.right_path, winner_mark=right_mark
        )
