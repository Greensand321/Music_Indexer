    ...
    def _generate_plan(
        ...
        *,
        ...
        try:
            ...
            if write_preview:
                self._record_preview_trace("metadata-read")
                self._record_preview_trace("artwork-read")
                self._record_preview_trace("artwork-compress")
            ...
            if write_preview:
                ...
                self._record_preview_trace("preview-html-write")
                export_consolidation_preview_html(
                    plan,
                    html_path,
